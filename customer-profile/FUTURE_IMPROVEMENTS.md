# Customer Profile Service - Future Improvements
...
- [ ] Define custom exception classes (e.g., `CustomerNotFoundException`, `InvalidSsnException`)
...
- [ ] Refactor repository layer with proper abstractions
...
- [ ] Add endpoint to update customer profile
- [ ] Add endpoint to delete customer profile
- [ ] Add endpoint to search customers by criteria
