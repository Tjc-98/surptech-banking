package org.surptech.bankingtester;
 ...
 * 
 * Usage:
 *   java -cp ... org.surptech.bankingtester.TestRunner [suite]
 * 
 * Suites:
...
public class TestRunner {
    ...
    private static final String TESTS_PACKAGE = "org.surptech.bankingtester.tests";
    private static final String SUITE_PACKAGE = "org.surptech.bankingtester.suite";

    public static void main(String[] args) {
        String suite = args.length > 0 ? args[0].toLowerCase() : "all";
        
        System.out.println("╔════════════════════════════════════════════════════════════════════════════╗");
        System.out.println("║           SurpTech Banking System - Test Runner                            ║");
        System.out.println("╚════════════════════════════════════════════════════════════════════════════╝");
        System.out.println();
        ...
        switch (suite) {
            ...
            case "smoke":
                builder.selectors(selectPackage(TESTS_PACKAGE))
                       ...
                       .build();
                // Use the suite class instead
                return LauncherDiscoveryRequestBuilder.request()
                        .selectors(org.junit.platform.engine.discovery.DiscoverySelectors
                                .selectClass("org.surptech.bankingtester.suite.SmokeTestsSuite"))
                        .build();
                
            case "integration":
                return LauncherDiscoveryRequestBuilder.request()
                        .selectors(org.junit.platform.engine.discovery.DiscoverySelectors
                                .selectClass("org.surptech.bankingtester.suite.IntegrationTestsSuite"))
                        .build();
            ...
            case "error-handling":
                builder.selectors(selectPackage(TESTS_PACKAGE))
                       .filters(org.junit.platform.engine.discovery.PackageNameFilter
                               .includePackageNames(TESTS_PACKAGE));
                // Filter by tag
                return LauncherDiscoveryRequestBuilder.request()
    ...
    private static void printUsage() {
        System.out.println("Usage: java -cp ... org.surptech.bankingtester.TestRunner [suite]");
        System.out.println();
        ...
        System.out.println("  java -cp ... org.surptech.bankingtester.TestRunner");
        System.out.println("  java -cp ... org.surptech.bankingtester.TestRunner smoke");
        System.out.println("  java -cp ... org.surptech.bankingtester.TestRunner integration");
    }
}
